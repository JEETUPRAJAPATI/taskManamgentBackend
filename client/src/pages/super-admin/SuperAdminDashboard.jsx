        ...
        <div className="bg-white rounded-xl border border-gray-200 p-6">
          ...
          <div className="space-y-3">
            {recentActivity.users.slice(0, 5).map((user) => (
              <div key={user._id} className="flex items-center gap-3 p-3 rounded-lg bg-gray-50">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs text-gray-500">
                    {user.organizationId?.name || 'No Company'} • {user.email}
                  </p>
                </div>
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-6">
          ...
          <div className="space-y-3">
            {recentActivity.tasks.slice(0, 5).map((task) => (
              <div key={task._id} className="flex items-center gap-3 p-3 rounded-lg bg-gray-50">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs text-gray-500">
                    {task.organizationId?.name} • {task.assignedTo?.firstName} {task.assignedTo?.lastName}
                  </p>
                </div>
                <span className="text-xs text-gray-400">
